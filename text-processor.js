...
export class TextProcessor {
    ...
    async processText(text) {
		...
		if (this.wordReader) {
			console.log('5. Prieš žodžių apdorojimą:', processedContent.substring(0,200));
			processedContent = this.wordReader.processWords(processedContent);
			console.log('6. Po žodžių apdorojimo:', processedContent.substring(0,200));
		}
	
		if (this.phraseReader) {
			console.log('7. Prieš frazių apdorojimą:', processedContent.substring(0,200));
			processedContent = this.phraseReader.processPhrases(processedContent);
			console.log('8. Po frazių apdorojimo:', processedContent.substring(0,200));
		}
